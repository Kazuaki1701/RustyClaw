...
- [ ] **Step 1: Create the script template with safety checks and backup**
...
- [ ] **Step 2: Commit scripts/reconstruct_phase3.sh template**
...
- [ ] **Step 1: Append Topic A, B, C, D, E and docs commits logic to the script**
...
- [ ] **Step 1: Append Phase 1 & 2 topic replays to the script**
