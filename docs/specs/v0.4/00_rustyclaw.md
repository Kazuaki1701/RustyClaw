...
| 追加対象 | 所在 | 説明 |
|---|---|---|
| `ExternalMcpController` | `rustyclaw-gateway` | context-mode 子プロセスのライフサイクル管理 |
| `ctx_execute` ツール定義 | `rustyclaw-tools` | context-mode MCP ツールのラッパー |
| `ctx_search` ツール定義 | `rustyclaw-tools` | context-mode MCP ツールのラッパー |
| `ctx_index` ツール定義 | `rustyclaw-tools` | context-mode MCP ツールのラッパー |
| `ctx_patch` ツール定義 | `rustyclaw-tools` | context-mode MCP ツールのラッパー |
...
| [`../v0.3/08_deployment.md`](../v0.3/08_deployment.md) | §16 | 運用ドキュメント | Node.js インストール手順追加予定 |
