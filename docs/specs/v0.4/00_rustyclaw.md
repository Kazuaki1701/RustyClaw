...
> **Upstream 比較**: [`91_upstream_comparison.md`](91_upstream_comparison.md) / [`91_context_upstream_comparison.md`](91_context_upstream_comparison.md)（context 管理特化）
...
|---|---|---|---|
| [`01_pipeline.md`](01_pipeline.md) | §4, §7 | `[実装済 + 残課題]` | §将来拡張 ContextBuilder 節 → v0.4 残課題（context window 対応） |
| [`02_memory.md`](02_memory.md) | §5, §9 | `[実装済 + 残課題]` | §5.3 70/20/10 コンテキスト戦略 → v0.4 残課題（Heartbeat Digest・Session Summary・window 対応） |
| [`03_llm_provider.md`](03_llm_provider.md) | §8 | `[実装済]` | 変更なし |
| [`04_workspace.md`](04_workspace.md) | §6 | `[実装済]` | `.context-mode/` ディレクトリ追加 |
| [`05_heartbeat.md`](05_heartbeat.md) | §10 | `[実装済]` | Phase 50: HA 環境コンテキスト注入（§10.6 追加） |
| [`06_hermes_skills.md`](06_hermes_skills.md) | §12 | `[将来拡張]` | ctx_execute / ctx_patch を前提に再設計 |
| [`07_extensions.md`](07_extensions.md) | §13〜17 | `[一部完了]` | §13（context-mode 委譲）・§14（HA 統合 Phase 50）・§15（rig-core）完了。§16・§17 は将来拡張 |
| [`08_deployment.md`](08_deployment.md) | §16 | 運用ドキュメント | Node.js ≥ 22.5 + context-mode インストール手順追加済み（§16.7） |
| [`09_dashboard.md`](09_dashboard.md) | — | `[実装済]` | 変更なし |
| [`10_mcp.md`](10_mcp.md) | — | `[実装済]` | context-mode は stdio transport で接続 |
| [`11_operation.md`](11_operation.md) | — | `[実装済]` | Phase 50: HA 監視項目追加済み。context-mode プロセス監視項目追加済み（§2-6） |
| [`12_storage.md`](12_storage.md) | §11 | `[実装済]` | RAG / Embedding 節は context-mode に委譲 |
