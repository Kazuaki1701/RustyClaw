...
> **ステータス**: `[ACTIVE]`
> **バージョン**: v0.4
> **最終更新日**: 2026-06-12（Phase 01〜03, 28b-3, 45-1, 47-1, 48-1, 50 実装完了）
...
| [`../v0.3/07_extensions.md`](../v0.3/07_extensions.md) | §13〜17 | `[将来拡張]` | §13・§14（本仕様）を実装完了（v0.4）。§14 は Phase 50 で bash スクリプト方式で実装 |
