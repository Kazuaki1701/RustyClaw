...
- [x] **Step 3: `discord_top_k` フィールドを追加する**
...
- [x] **Step 1: `execute_with_rig_agent` の RAG ブロックを修正する**
...
- [x] **Step 1: `docs/task.md` の ISSUE-33 を完了済みにする**
