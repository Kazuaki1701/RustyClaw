...
Use the `todo-tracker` skill to record in `TODO.md`:
...
Example:
```markdown
- [ ] Add {function} to src/foo.rs <!-- Done when: cargo test passes -->
- [ ] Add tests to tests/foo_test.rs <!-- Done when: cargo test passes -->
```
