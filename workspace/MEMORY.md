...
- **Boss Patterns:** K様の判断基準、こだわり、行動ルールを `memory/BOSS_PATTERNS.md` に集約。 [2026-04-05]
...
## Technical Insights
- **Agent Environment:** `sandboxEnv` 変更の反映にはサービス再起動 (`systemctl --user restart geminiclaw`) が必要. [2026-04-11]
...
## Important Context
- **Knowledge Base:** 記憶を `GEMI_core/`, `GEMI_activities/`, `GEMI_knowledge/` に再編。 [2026-04-09]
- **Workspace:** マウント先 `memory/ObsidianVault`、構造は `WORKSPACE_STRUCTURE.md`。 [2026-04-10]
